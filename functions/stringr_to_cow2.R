...
stringr.to.cow<-function(country, year, data){
  ...
  42 -> ccode$ccode[str_detect(ccode$cctry, fixed("Dom. Rep.", ignore_case=TRUE))]
  ...
  265 -> ccode$ccode[str_detect(ccode$cctry, fixed("GDR", ignore_case=TRUE))]
  ...
  316 -> ccode$ccode[str_detect(ccode$cctry, fixed("Czech Rep.", ignore_case=TRUE))]
  ...
  402 -> ccode$ccode[str_detect(ccode$cctry, fixed("C. Verde Is.", ignore_case=TRUE))]
  ...
  482 -> ccode$ccode[str_detect(ccode$cctry, fixed("Cent. Af. Rep.", ignore_case=TRUE))]
  482 -> ccode$ccode[str_detect(ccode$cctry, fixed("Central African Rep", ignore_case=TRUE))]
  ...
  560 -> ccode$ccode[str_detect(ccode$cctry, fixed("S. Africa", ignore_case=TRUE))]
  ...
  581 -> ccode$ccode[str_detect(ccode$cctry, fixed("Comoro Is.", ignore_case=TRUE))]
  ...
  696 -> ccode$ccode[str_detect(ccode$cctry, fixed("UAE", ignore_case=TRUE))]
  ...
  710 -> ccode$ccode[str_detect(ccode$cctry, fixed("PRC", ignore_case=TRUE))]
  ...
  731 -> ccode$ccode[str_detect(ccode$cctry, fixed("PRK", ignore_case=TRUE))]
  ...
  732 -> ccode$ccode[str_detect(ccode$cctry, fixed("ROK", ignore_case=TRUE))]
  ...
  940 -> ccode$ccode[str_detect(ccode$cctry, fixed("Solomon Is.", ignore_case=TRUE))]
